...
public static int twoDimensionalArrayOperation(int[][] array) {
    ...
    public static void main(String[] args) {
        // Ejemplo 1: Un array de una sola fila
        int[][] example1 = { {0, 4, 8, 5} };
        System.out.println("Input: [[0, 4, 8, 5]]");
        System.out.println("Producto de sumas de filas: " + twoDimensionalArrayOperation(example1));
    }
}
